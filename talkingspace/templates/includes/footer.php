				...
				<div class="sidebar">
					...
					<div class="block">
						...
						<div class="list-group">
							...
							<a href="topics.php?category=<?php echo $category->id; ?>" class="list-group-item <?php echo is_active($category->id); ?>"><?php echo $category->name ?> <span class="badge pull-right">15</span></a>
							<?php endforeach; ?>
						</div>
					</div>				
				</div>
